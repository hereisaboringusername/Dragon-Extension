...
public class GameScreen implements Screen {
  //changed to be about the Dragon game
   final Dragon game;

   Texture dragonImage;
   Sprite dragonSprite; 
    //put all other textures and sprites here
  
   //Music goes under here
   Sound dropSound;
   Music rainMusic;
   ...
   public GameScreen(final Dragon gam) {
      this.game = gam;
      //load all images and sprites here
      ...
      // load the sound effect and  background "music"
     ...
     //additional sound effects go below here
      ...
      // create the dragons array and spawn the first dragons
      raindrops = new Array<DragonSprite>(); // Project 1
      spawnRaindrop();
   } // end constructor


//change to spawnRaindrop instead
...
// Other drawing here.
   ...
   //make bucket into a sprite first
   @Override
